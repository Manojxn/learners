      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-12 lg:mb-16">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-gray-600 px-4">
            Our foundation is built on principles that drive our educational philosophy and institutional values.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          ...
          >
            ...
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
              To be the most respected and innovative educational institution, recognized globally for developing
              future-ready leaders who drive meaningful change in an interconnected world through knowledge,
          ...
          <motion.div
            ...
            className="bg-white p-6 sm:p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow"
          >
            <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-secondary/10 flex items-center justify-center mb-4 sm:mb-6">
            ...
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
              To empower students with a transformative educational experience that combines academic excellence,
              character development, and real-world readiness. We cultivate critical thinking, creativity, and
              compassion, preparing students to excel in their careers and make a positive impact on society.
            </p>
          </motion.div>
        </div>
      </div>
