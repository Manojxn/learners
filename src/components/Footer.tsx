  ...
  const socialMedia = [
    {
      name: 'Facebook',
      icon: FacebookIcon,
      href: 'https://www.facebook.com/share/17nuSeiQGP/',
      hoverColor: 'hover:text-[#1877F2]'
    },
    {
      name: 'YouTube',
      icon: YouTubeIcon,
      href: 'https://youtube.com/@learnerspuc6316?si=WRvHn7QmvFK333nC',
      hoverColor: 'hover:text-[#FF0000]'
    },
    {
      name: 'Instagram',
      icon: InstagramIcon,
      href: 'https://www.instagram.com/learners_global_school_mysuru?igsh=MTk5aXFyYm8zdG0zdg==',
